...
const SIDEBAR_DAYS = [
  {
    ...
    sessions: [
      ...
      { name: "SharePoint & M365",              href: "session-d1-b07-sharepoint.html", sid: "d1-b07-sharepoint" },
      { name: "Networking virtual",             href: "session-d1-b08-networking.html", sid: "d1-b08-networking" }
    ]
  },
  {
    ...
    sessions: [
      ...
      { name: "Value Stream Analysis (VSA)",  href: "session-d2-b03-vsa.html", sid: "d2-b03-vsa" },
      { name: "MEF · Evaluación Financiera",  href: "session-d2-b04-mef.html", sid: "d2-b04-mef" },
      { name: "PASER · sistema de gestión",   href: "session-d2-b05-paser.html", sid: "d2-b05-paser" },
  ...
  },
  {
    ...
    sessions: [
      ...
      { name: "Presentación a panel",         href: "session-d5-b02-panel.html", sid: "d5-b02-presentacion" },
